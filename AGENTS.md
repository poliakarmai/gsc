...
GSC — самообучающаяся AppSec-платформа: 49 детекторов (45 registry + 4 движка: Secrets/SCA/IaC/Invariants),
...
├── gsc_meta.py                   ← SSOT: 210 модулей, 49 детекторов, schema 33
