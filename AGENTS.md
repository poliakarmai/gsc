...
GSC — самообучающаяся AppSec-платформа: 46 детекторов (42 registry + 4 движка: Secrets/SCA/IaC/Invariants),
...
├── gsc_meta.py                   ← SSOT: 159 модулей, 46 детекторов, schema 33
