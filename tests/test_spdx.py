...
test('download location by ecosystem', t3)
...
test('CDX to SPDX conversion', t4)

def t5():
    assert canonical_json({"b":2,"a":1}) == canonical_json({"a":1,"b":2})
test('canonical JSON stable', t5)
