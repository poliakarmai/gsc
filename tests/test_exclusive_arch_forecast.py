...
run_case('content_fingerprint survives whitespace', t1)
...
run_case('content_fingerprint changes with code', t2)
...
run_case('calc_risk_score: high density + churn → critical', t3)
...
run_case('calc_risk_score: clean file → low', t4)
...
run_case('risk_level boundaries', t5)
