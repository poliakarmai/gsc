...
test('SCA → CycloneDX pipeline', t1)
...
test('CycloneDX → SPDX roundtrip', t3)
...
test('IaC detector type routing', t7)
...
test('Federated privacy: no code leak', t10)
